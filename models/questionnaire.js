...
const questionnaireSchema = new Schema({
    ...
    questions: {
        passionateIssues: { type: String, default: "Which cause or issues are you most passionate about?" },
        locationScope: { type: String, default: "Would you prefer to support local, national, regional, or international initiatives?" },
        organizationType: { type: String, default: "What type of organization(s) would you like to support?" },
        specifics: { type: String, default: "Any specific criteria you would like to support?" },
        donationFrequency: { type: String, default: "How often do you donate or wish to donate?" },
    },
    passionateIssues: {
